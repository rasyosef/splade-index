...
class SPLADE_GPU:
    ...
    def save(
        ...
        with open(vocab_path, "wt", encoding="utf-8") as f:
            f.write(utils.json_functions.dumps(self.vocab_dict, ensure_ascii=False))
    ...
    def load(
        ...
        with open(params_path, "r") as f:
            params: dict = utils.json_functions.loads(f.read())

        # Load the vocab dictionary
        if load_vocab:
            vocab_path = save_dir / vocab_name
            with open(vocab_path, "r", encoding="utf-8") as f:
                vocab_dict: dict = utils.json_functions.loads(f.read())
        else:
            vocab_dict = {}
            ...
            if os.path.exists(corpus_path):
                ...
                if mmap:
                    ...
                    with open(corpus_path, "r", encoding="utf-8") as f:
                        for line in f:
                            doc = utils.json_functions.loads(line)
